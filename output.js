//Mon Jun 02 2025 08:27:16 GMT+0000 (Coordinated Universal Time)
...
let httpReq;
let httpResp;
let userCookie = ($.isNode() ? process.env.dyjsbbf : $.getdata("dyjsbbf")) || "";
let userList = [];
let userIdx = 0;
let userCount = 0;
let id;
...
class UserInfo {
  ...
  async fqqdrw() {
    try {
      ...
      let _0x544268 = "{\"task_key\":\"" + this.tid + "\"}";
  ...
  async fqqdbxlx() {
    try {
      ...
      let _0x531406 = "{\"task_key\":\"excitation_ad_treasure_box\",\"rit\":\"28038\",\"creator_id\":\"12317000\",\"one_more_round\":" + this.tid + "}";
  ...
  async fqkgg() {
    try {
      ...
      let _0x13fecc = "{\"from\":\"excitation_ad\"}";
  ...
  async fqzl() {
    ...
    try {
      ...
      let _0x256284 = "{\"submit_time\":" + _0x5c1375 + ",\"step\":11145}";
  ...
  async fqcfsp() {
    try {
      ...
      let _0x574a12 = "{\"task_key\":\"meal_excitation_ad\",\"rit\":\"28038\",\"creator_id\":\"12320000\",\"one_more_round\":0}";
  ...
  async fqfx() {
    try {
      ...
      let _0x446d07 = "{\"moment_id\":\"" + this.tid + "\"}";
  ...
  async populateUrlObject(_0x3404e1, _0x6267b0 = "") {
    ...
    _0x6267b0 && (_0x302480.body = _0x6267b0);
...
function randomString(_0x11d933 = 12) {
  ...
  let _0x18eefa = _0x3d0d77.length;
  let _0x45d861 = "";
...
function populateUrlObject(_0x2ddfb0, _0x56cdc1, _0x584226 = "") {
  ...
  _0x584226 && (_0x332d0d.body = _0x584226);
  return _0x332d0d;
}
...
function random(_0x213bf5 = 12) {
  ...
  let _0x3a38bb = _0x33fbef.length;
  let _0x199df9 = "";
