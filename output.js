//Sun Dec 22 2024 07:42:35 GMT+0000 (Coordinated Universal Time)
...
function jxUser(_0x417bf1) {
  ...
  return _0x5739bf.forEach(_0xbe2894 => {
...
function Env(_0x4e302c, _0x5ce487) {
  ...
  class _0xbba2b {
    ...
    ["send"](_0x116d30, _0x3610da = "GET") {
      ...
      return "POST" === _0x3610da && (_0x620610 = this.post), new Promise((_0x220dd2, _0x4cba8e) => {
  ...
  return new class {
    ...
    ["lodash_get"](_0x2db767, _0x4b2b5f, _0x4a4677) {
      ...
      for (const _0x370c9c of _0x27d25a) if (_0x195b2a = Object(_0x195b2a)[_0x370c9c], void 0 === _0x195b2a) return _0x4a4677;
      return _0x195b2a;
    }
    ...
    ["setval"](_0x531b42, _0x22a570) {
      return this.isSurge() || this.isLoon() ? $persistentStore.write(_0x531b42, _0x22a570) : this.isQuanX() ? $prefs.setValueForKey(_0x531b42, _0x22a570) : this.isNode() ? (this.data = this.loaddata(), this.data[_0x22a570] = _0x531b42, this.writedata(), !0) : this.data && this.data[_0x22a570] || null;
    }
    ["initGotEnv"](_0x4093bc) {
      this.got = this.got ? this.got : require("got");
      this.cktough = this.cktough ? this.cktough : require("tough-cookie");
      this.ckjar = this.ckjar ? this.ckjar : new this.cktough.CookieJar();
      _0x4093bc && (_0x4093bc.headers = _0x4093bc.headers ? _0x4093bc.headers : {}, void 0 === _0x4093bc.headers.Cookie && void 0 === _0x4093bc.cookieJar && (_0x4093bc.cookieJar = this.ckjar));
    }
